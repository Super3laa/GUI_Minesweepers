GUI created using QtCreator for monitoring the robot's status(Sensors, Navigation system, controller signals and live graphical simulation of the robot in the mine field).
